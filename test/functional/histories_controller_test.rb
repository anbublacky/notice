...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { body: @history.body, orbituarysite_id: @history.orbituarysite_id, title: @history.title }
    end
  ...
  test "should update history" do
    put :update, id: @history, history: { body: @history.body, orbituarysite_id: @history.orbituarysite_id, title: @history.title }
    assert_redirected_to history_path(assigns(:history))
  end
